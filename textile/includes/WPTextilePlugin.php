        ...
        <div class="wptextile_tabs_container">
            ...
            <div class="wptextile_tab_content archive hide">
                ...
                <div id="wptextile_archive_section_post_list" class="hide">
                    ...
                    <p>
                        This is the main page for your bucket. An index.html file will be autogenerated and uploaded to your bucket for you ;)
                        <input class="button button-primary" type="button" id="textile_archive_btn_generate_index" value="CREATE INDEX FILE">
                    </p>
            ...
            <div class="wptextile_tab_content filecoin hide">
                <h2 class="tab_title">Filecoin</h2>
